...
// Background images for slideshow (replace with your own galeri images)
...
// Typing effect texts for galeri
const typingTexts = [
  'Dokumentasi Kegiatan Kami',
  'Momen Berharga di PT SAI',
  'Galeri Foto Industri Otomotif'
];
...
const GaleriHero = () => {
  ...
  return (
    <div className="relative min-h-[60vh]">
      ...
      {/* Main Content */}
      <div className="relative z-20 flex flex-col items-center justify-center min-h-[60vh] px-4 pt-24 pb-16">
